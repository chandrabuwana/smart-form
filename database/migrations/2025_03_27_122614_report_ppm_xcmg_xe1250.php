...
return new class extends Migration
{
    ...
    {
        Schema::create('report_ppm_xcmg_xe1250', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('doc_num_id')->references('doc_num')->on('ppm_xcmg_xe1250')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('report_ppm_xcmg_xe1250');
    }
};
