...
class InspectionDongfeng extends Model {
    ...
    protected $fillable = [
        'site', 'model_unit', 'cn', 'hm', 'dilakukan1', 'dilakukan2', 'diperiksa', 'note', 'date_inspection', 'creator', 'diketahui', 'date_sign1', 'date_sign2', 'date_sign3', 'status_form', 'status', 'created_at', 'updated_at'
    ];
