            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Dashboard Form PPM XCMG GR3005T SERIES</h6>
                    </div>
                </div>
                <!-- Statistics Cards -->
                ...
                <div class="card-body px-0 pb-2">
                    <div class="d-flex align-items-center mx-3">
                        <a href="{{ route('plant.ppm.3005.form') }}">
                                                ...
                                                @if ($session == $data->creator)
                                                    @if ($data->status === 'rejected' || $data->status === 'draft')
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-sm mt-3"
                                                            onclick="deleteXcmg3005('{{ $data->doc_num }}')">
                                                            <i class="fas fa-trash"></i>
                                                        </button>
                                                    @endif
                                                @endif
                                                <a href="{{ route('plant.ppm.3005.show', ['id' => $data->id]) }}"
    ...
    <script>
        ...
        $(function() {
            ...
            $('#btnClearFilter').click(function() {
                window.location.href = '{{ route('plant.ppm.3005.dashboard') }}';
            });
        ...
        function deleteXcmg3005(id) {
            console.log('Delete ID:', id);
            if (confirm('Are you sure you want to delete this data?')) {
                axios.delete('{{ route('plant.ppm.3005.delete', ['id' => 'ID']) }}'.replace('ID', id))
