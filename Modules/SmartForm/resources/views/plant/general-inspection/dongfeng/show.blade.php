            ...
            <div class="row">
                ...
                <div class="col-6 mt-2">
                    <div class="input-group input-group-static mb-3">
                        ...
                        <select name="diperiksa" id="diperiksa" class="form-control" disabled>
                        </select>
                    </div>
                </div>
                <div class="col-6 mt-2">
                    <div class="input-group input-group-static mb-3">
                        ...
                        <select name="diketahui" id="diketahui" class="form-control" disabled>
                        </select>
                    </div>
                </div>
            </div>
...
@section('custom-js')
    ...
    <script>
        ...
        $(function() {
            const selectedNama = '{{ $inspection['diperiksa'] }}';
        ...
        $(function() {
            const selectedNama = '{{ $inspection['diketahui'] }}';
    ...
    <script>
        ...
        function resetApproval(id) {
            if (confirm('Are you sure you want to reset this Approval?')) {
                axios.post('{{ route('bss-form.plant.general-inspection.dongfeng.reset', ['id' => 'ID']) }}'.replace('ID',
                        id))
                    .then(function(response) {
                        console.log('Response:', response);
                        if (response.data.success) {
