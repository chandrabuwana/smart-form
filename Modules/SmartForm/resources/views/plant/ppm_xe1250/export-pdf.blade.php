...
<head>
    <meta charset="UTF-8">
    <title>Form PPM XCMG XE1250</title>
...
<body>
    <div class="top">
        <p class="title">BSS-FRM-PLA-071 FORM PPM XCMG XE1250</p>
    </div>
    <table class="container">
        ...
        <tr>
            ...
            <td rowspan="2" style="border: none; font-weight: bold; background-color:bisque;">XCMG XE1250</td>
        </tr>
        <tr>
            <td>Job Site : </td>
