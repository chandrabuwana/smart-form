                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-static mb-3">
                                        ...
                                        {!! \Modules\SmartForm\helpers\SiteHelper::renderSiteSelect('job_site', null, false, true, 'job_site', 'form-control uppercase') !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group input-group-static mb-3">
                                        ...
                                        <select class="form-control uppercase" name="location" id="location" required>
                                            ...
                                            <option value="Service">Service Pad Area</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(function() {
            ...
            form.submit(function(e) {
                ...
                axios.post('{{ route('plant.ppm.xe1250.store') }}', formData)
