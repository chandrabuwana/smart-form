            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Dashboard Router Maintenance</h6>
                    </div>
                </div>
                ...
                <div class="card-body px-0 pb-2">
                    <div class="d-flex align-items-center mx-3">
                        <a href="{{ route('it-ops.form-router') }}">
                    ...
                    <div class="table-responsive p-0">
                        <table id="list-form" class="table table-hover">
                            ...
                            <thead>
                                <tr>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Date</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Name</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">NIK</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Dept</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Site</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Asset No</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Asset Type</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Brand</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Model</th>
                                    <th data-sortable="true" data-align="center" data-halign="text-center">Components</th>
                                    <th data-align="center" data-halign="text-center">Actions</th>
                                </tr>
                            </thead>
                            </thead>
                            <tbody>
                                @forelse($maintenanceRecords as $record)
                                    <tr>
                                        <td data-align="center" data-halign="text-center">{{ $record->created_at }}</td>
                                        <td data-align="center" data-halign="text-center">{{ $record->nama }}</td>
                                        <td data-align="center" data-halign="text-center">{{ $record->nik }}</td>
                                        <td data-align="center" data-halign="text-center">{{ $record->dept }}</td>
                                        <td data-align="center" data-halign="text-center">{{ $record->site }}</td>
                                        <td data-align="center" data-halign="text-center">{{ $record->no_asset }}</td>
                                        <td data-align="center" data-halign="text-center">{{ $record->jenis_aset }}</td>
                                        <td data-align="center" data-halign="text-center">{{ $record->merk }}</td>
                                        <td data-align="center" data-halign="text-center">{{ $record->model }}</td>
                                        <td data-align="center" data-halign="text-center">
