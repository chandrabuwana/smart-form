                                ...
                                @forelse($maintenanceRecords as $record)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('it-ops.edit-printer') }}?id={{ $record->id }}" class="btn btn-info btn-action text-white">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <button type="button" class="btn btn-danger btn-action delete-printer" data-id="{{ $record->id }}">
...
@section('custom-js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-printer').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('it-ops.delete-printer') }}",
                            type: "POST",
                            data: {
                                id: id,
                                _token: "{{ csrf_token() }}"
