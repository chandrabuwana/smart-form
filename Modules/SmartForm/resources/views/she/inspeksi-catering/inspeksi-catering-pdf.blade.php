            ...
            <tr> 
                <table>
                    ...
                    <tr class="datanilaiitem">
                        ...
                        <td class="data">{{$data->q_keterangan_penerimaan_5}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>6.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penerimaan_6}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>7.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penerimaan_7}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>8.</td>
                    ...
                    <tr class="datanilaiitem">
                        ...
                        <td class="data">{{$data->q_keterangan_penerimaan_10}}</td>
                    </tr>
                </table>
            </tr>
        </table>
            ...
            <tr> 
                <table>
                    ...
                    <tr class="datanilaiitem">
                        ...
                        <td class="data">{{$data->q_keterangan_penyimpanan_1}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>2.</td>
            ...
            <tr> 
                <table>
                    ...
                    <tr class="datanilaiitem">
                        ...
                        <td class="data">{{$data->q_keterangan_persiapan_3}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>4.</td>
                    ...
                    <tr class="datanilaiitem">
                        ...
                        <td class="data">{{$data->q_keterangan_persiapan_6}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>7.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_persiapan_7}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>8.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_persiapan_8}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>9.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_persiapan_9}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>10.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_persiapan_10}}</td>
                    </tr>
                </table>
            </tr>
        </table>
            ...
            <tr> 
                <table>
                    ...
                    <tr class="datanilaiitem">
                        ...
                        <td class="data">{{$data->q_keterangan_pengolahan_7}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>8.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_pengolahan_8}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>9.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_pengolahan_9}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>10.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_pengolahan_10}}</td>
                    </tr>
                </table>
            </tr>
        </table>
            ...
            <tr> 
                <table>
                    ...
                    <tr class="datanilaiitem">
                        ...
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_1}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>2.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_2}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>3.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_3}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>4.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_4}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>5.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_5}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>6.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_6}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>7.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_7}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>8.</td>
                        ...
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_8}}</td>
                    </tr>
                    <tr class="datanilaiitem">
                        <td>9.</td>
                        <td style="text-align:left">Apakah tempat penerimaan sudah disiapkan bersih dan aman</td>
                        <td class="data">{{$data->q_penggolongan_sampah_9}}</td>
                        <td class="data">{{$data->q_keterangan_penggolongan_sampah_9}}</td>
                    </tr>
                </table>
            </tr>
        </table>
    ...
    <div class="margin-top">
        <table style="width:100%" class="kop">
          ...
          <tr class="itemKop">
            ...
            <td style="text-align:left">: {{$data->mengetahui}}</td>
            <td style="text-align:left">Tanda Tangan</td>
            <td style="text-align:left">: Signed</td>
            <td style="text-align:left">Tanggal</td>
            <td style="text-align:left">: ...............</td>
