                        ...
                        <table class="table table-bordered" style="width: 100%">
                            <tr>
                                <td rowspan="2" style="width: 15%">
                                    <img src="{{ asset('images/bss-logo.png') }}" alt="BSS Logo" style="max-width: 100px;">
                                </td>
                                <td class="text-center bg-light" style="width: 70%">
                                    <h5 class="mb-0">BSS SHE Management System</h5>
                                    <h6 class="mb-0">FORM</h6>
                                </td>
                                <td style="width: 15%">
                                    <div class="small">
                                        <div>No Dok: BSS-FRM-SHE-037</div>
                                        <div>Revisi: 00</div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center">
                                    <h5 class="mb-0">INSPEKSI EYEWASH</h5>
                                </td>
                                <td>
                                    <div class="small">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-static">
                                        ...
                                        <input type="date" name="inspection_date" class="form-control" required
                                            value="{{ $isShowDetail ? $maintenanceRecord->inspection_date : now()->format('d F Y') }}"
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-static">
                                        ...
                                        <input type="text" name="created_by" class="form-control" required
                                            value="{{ $isShowDetail ? $maintenanceRecord->created_by : '' }}"
                                            {{ $isShowDetail ? 'disabled' : '' }}>
                                    </div>
                                </div>
                                <div class="col-md-3">
