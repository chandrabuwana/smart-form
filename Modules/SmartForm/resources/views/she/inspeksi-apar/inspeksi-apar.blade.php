            ...
            <div class="card my-4">
                ...
                <div class="card-body my-1">
                    ...
                    <div class="table-responsive p-0">
                        <table id="list-inspeksi-apar" data-toggle="table" data-ajax="fetchFormsData"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="lokasi" data-align="left" data-halign="text-center" data-sortable="true">Lokasi Inspeksi</th>
                                    <th data-field="tgl" data-align="left" data-halign="text-center" data-sortable="true">Tanggal</th>
...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        function fetchFormsData(params) {
            ...
            var url = '/bss-form/she-019B/list-inspeksi-apar'
        ...
        function actionFormatter(value, row, index) {
            return `
                <a class="btn btn-primary btn-action btn-sm" href="/bss-form/she-019B/pdf-inspeksi-apar/${row.id}">Pdf</a>
            `;
        }
