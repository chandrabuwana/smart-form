            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">User Vendor PPH</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div class="d-flex align-items-center ms-3">
                        <a href="{{ route('bss-pph-vendor.add') }}">
                    ...
                    <div class="mx-3 row mb-3">
                        <div class="col-6 col-md-3 ps-0">
                            <div class="input-group input-group-static mb-4">
                                <label for="filterNik">NPWP / Email / Nama</label>
                                <input style="width: 100%" id="filterKeyword" class="form-control" name="filterKeyword" placeholder="--- Cari NPWP / Email / Nama.. ---">
                            </div>
                        </div>
                    ...
                    <div class="table-responsive p-0">
                        <table id="list-vendor" data-toggle="table" data-ajax="fetchFormsData"
                            ...
                            <thead>
                                <tr>
                                    <th data-field="npwp" data-align="left" data-halign="text-center" data-sortable="true">
                                        NPWP
                                    </th>
                                    <th data-field="Email" data-align="center" data-halign="center">
                                        Email
                                    </th>
...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        function fetchFormsData(params) {
            ...
            var url = `<?= route('bss-pph-vendor.fetch-dashboard-data') ?>`
