...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        // var btn = '<a type="button" class="btn btn-secondary style="--bs-btn-font-size: .60rem;" href="/bss-form/sm/approve-supplier?id=' + row.id + '">Lihat</a>';
        
        function actionFormatter(value, row, index) {
            var btn = '<a type="button" class="btn btn-secondary btn-sm me-1" style="--bs-btn-font-size: .60rem;" href="/bss-form/sm/approve-supplier?id=' + row.id + '">Lihat</a>';
