            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Dashboard Form P2H UNIT CMT - LGMG</h6>
                    </div>
                </div>
                <!-- Statistics Cards -->
                        ...
                        <div class="card stats-card">
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="text-end pt-1">
                                        <p class="text-sm mb-0 text-capitalize">No Unit</p>
                                        <h4 class="mb-0">{{ $statistics->no_unit }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="input-group input-group-static mb-4 position-relative">
                                        ...
                                        <input type="text" class="form-control" id="no_unit" name="no_unit" value="{{ $filters['no_unit'] ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="input-group input-group-static mb-4 position-relative">
                                        <label for="nama_operator" class="ms-0">Nama Operator</label>
                                        <input type="text" class="form-control" id="nama_operator" name="nama_operator" value="{{ $filters['nama_operator'] ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-3
                                mb-3">
                                ...
                                <tbody>
                                    @foreach ($record as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $data->no_unit }}</p>
                                            </td>

                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $data->nama_operator }}</p>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('lgmg.show', ['id' => $data->id]) }}"
                                                ...
                                                @if (collect($status)->every(fn($s) => $s === 'approved'))
                                                    <a href="{{ route('lgmg.export', ['id' => $data->id]) }}"
    ...
    <script>
        ...
        function deleteXcmg900(id) {
            ...
            if (confirm('Are you sure you want to delete this data?')) {
                axios.delete('{{ route('lgmg.delete', ['id' => 'ID']) }}'.replace('ID', id))
