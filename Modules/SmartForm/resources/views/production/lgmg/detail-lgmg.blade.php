            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form id="formXCMG900" method="POST">
                        @csrf
                        <div class="mx-3">
                            <input type="hidden" name="lgmg_id" id="lgmg_id" value="{{ $lgmg->id }}">
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="input-group input-group-static mb-3">
                                        <label for="nama_operator" class="ms-0">Nama Operator</label>
                                        <input type="text" class="form-control" id="nama_operator" value="{{ $lgmg->nama_operator }}" name="nama_operator" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <tr>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-static mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nrp" name="nrp" value="{{ $lgmg->nrp }}"
                                            >
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-static mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control" value="{{ $lgmg->fuel_awal }}" id="fuel_awal" name="fuel_awal" pattern="\d+(\.\d{1,2})?" title="Format: 0.00 (maksimal 2 angka desimal)">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group input-group-static mb-3">
                                        <label for="fuel_akhir" class="ms-0">FUEL AKHIR</label>
                                        <input type="number" step="0.01" min="0" class="form-control" value="{{ $lgmg->fuel_akhir }}" id="fuel_akhir" name="fuel_akhir" pattern="\d+(\.\d{1,2})?" title="Format: 0.00 (maksimal 2 angka desimal)">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group input-group-static mb-3">
                                        <label for="tanggal" class="ms-0">TANGGAL</label>
                                        <input type="date" class="form-control" value="{{ $lgmg->tanggal }}" id="tanggal" name="tanggal" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-static mb-3">
                                        ...
                                        <input type="text" class="form-control" id="no_unit" name="no_unit" value="{{ $lgmg->no_unit }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group input-group-static mb-3">
                                        <label for="km_star" class="ms-0">KM STAR</label>
                                        <input type="number" value="{{ $lgmg->km_star }}" step="0.01" min="0" class="form-control" id="km_star" name="km_star" pattern="\d+(\.\d{1,2})?" title="Format: 0.00 (maksimal 2 angka desimal)">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group input-group-static mb-3">
                                        <label for="km_akhir" class="ms-0">KM AKHIR</label>
                                        <input type="number" step="0.01" value="{{ $lgmg->km_akhir }}" min="0" class="form-control" id="km_akhir" name="km_akhir" pattern="\d+(\.\d{1,2})?" title="Format: 0.00 (maksimal 2 angka desimal)">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="input-group input-group-static mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0" value="{{ $lgmg->hm_star }}" class="form-control" id="hm_star" name="hm_star" pattern="\d+(\.\d{1,2})?" title="Format: 0.00 (maksimal 2 angka desimal)">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group input-group-static mb-3">
                                        <label for="hm_akhir" class="ms-0">HM AKHIR</label>
                                        <input type="number" step="0.01" min="0" class="form-control" value="{{ $lgmg->hm_akhir }}" id="hm_akhir" name="hm_akhir" pattern="\d+(\.\d{1,2})?" title="Format: 0.00 (maksimal 2 angka desimal)">
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="input-group input-group-static mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="keterangan{{ $i }}" name="keterangan{{ $i }}" value="{{ $keterangan[$i - 1] ?? '' }}">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endfor
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    <div class="input-group input-group-static mb-3">
                                        ...
                                        <textarea name="catatan_rm" id="catatan_rm" class="form-control">{{ $lgmg->catatan_rm }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
        ...
        $('#btnSubmit').on('click', function (e) {
            ...
            $("table tr").each(function () {
                ...
                if (questionID) {
                    ...
                    formData.jawaban[questionID] = jawaban;
                    formData.category[questionID] = category;
                }
            });

            formData.jawaban = Object.entries(formData.jawaban).reduce((acc, [key, value]) => {
                acc[key] = value;
                return acc;
            }, {});

            formData.category = Object.entries(formData.category).reduce((acc, [key, value]) => {
                acc[key] = value;
                return acc;
            }, {});
            ...
            $.ajax({
                url: "{{ route('lgmg.update', ['id' => $lgmg->id]) }}",
                type: "POST",
