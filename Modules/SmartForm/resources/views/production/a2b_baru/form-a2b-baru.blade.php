                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{1}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 1, isset($record->deskripsi[0]) ? $record->deskripsi[0] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{2}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 2, isset($record->deskripsi[1]) ? $record->deskripsi[1] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{3}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 3, isset($record->deskripsi[2]) ? $record->deskripsi[2] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{4}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 4, isset($record->deskripsi[3]) ? $record->deskripsi[3] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{5}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 5, isset($record->deskripsi[4]) ? $record->deskripsi[4] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{6}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 6, isset($record->deskripsi[5]) ? $record->deskripsi[5] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{7}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 7, isset($record->deskripsi[6]) ? $record->deskripsi[6] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{8}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 8, isset($record->deskripsi[7]) ? $record->deskripsi[7] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{9}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 9, isset($record->deskripsi[8]) ? $record->deskripsi[8] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{10}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 10, isset($record->deskripsi[9]) ? $record->deskripsi[9] : '') }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <textarea class="form-control" name="deskripsi_{{12}}"{{ $isShowDetail ? 'disabled' : '' }}>{{ old('deskripsi_' . 12, isset($record->deskripsi[11]) ? $record->deskripsi[11] : '') }}</textarea>
                                            </td>
                                        </tr>
