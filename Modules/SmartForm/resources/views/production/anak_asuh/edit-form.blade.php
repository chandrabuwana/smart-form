                                ...
                                <table class="table table-bordered" id="anakAsuhTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="row_{{ $i }}">
                                            ...
                                            <td>{{ $i }}</td>
                                            <td>
                                                <select name="nama_anak_asuh_{{ $i }}" class="form-control text-center">
...
<script>
    $(function() {
        ...
        $("#tanggal").flatpickr({
            dateFormat: "Y-m-d",
            defaultDate: "{{ $record->tanggal ?? date('Y-m-d') }}",
            ...
            if (currentRowCount < maxRows) {
                ...
                const newRow = `
                    <tr id="row_${nextRowNumber}">
                        <td>
                            <input type="date" class="form-control" name="tanggal_${nextRowNumber}">
                        </td>
                        <td>
                            <select class="form-control" name="shift_${nextRowNumber}">
                                <option value="">-- Pilih Shift --</option>
                                <option value="DS" ${mainShift === 'DS' ? 'selected' : ''}>DS</option>
                                <option value="NS" ${mainShift === 'NS' ? 'selected' : ''}>NS</option>
                            </select>
                        </td>
                        <td>${currentRowCount}</td>
                        <td>
                            <select name="nama_anak_asuh_${nextRowNumber}" class="form-control text-center select2-anak-asuh">
                                <option value="" selected>-- Pilih Anak Asuh --</option>
                        ...
                        <td class="checkbox-cell">
                            <div class="checkbox-wrapper">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="attendance_${nextRowNumber}" value="hadir">
                                </div>
                            </div>
                        </td>
                        <td class="checkbox-cell">
                            <div class="checkbox-wrapper">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="attendance_${nextRowNumber}" value="izin">
                                </div>
                            </div>
                        </td>
                        <td class="checkbox-cell">
                            <div class="checkbox-wrapper">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="attendance_${nextRowNumber}" value="sakit">
                                </div>
                            </div>
                        </td>
                        <td class="checkbox-cell">
                            <div class="checkbox-wrapper">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="attendance_${nextRowNumber}" value="alfa">
                                </div>
                            </div>
                        </td>
                        <td>
                            <textarea class="form-control" name="review_temuan_${nextRowNumber}" rows="2"></textarea>
                        </td>
                        <td>
                            <select class="form-control" name="disiplin_score_${nextRowNumber}">
                                <option value="">--</option>
                                @foreach(range(1, 4) as $score)
                        ...
                        <td>
                            <select class="form-control" name="skill_score_${nextRowNumber}">
                                <option value="">--</option>
                                @foreach(range(1, 4) as $score)
                                    <option value="{{ $score }}">{{ $score }}</option>
                                @endforeach
                        ...
                        <td>
                            <select class="form-control" name="attitude_score_${nextRowNumber}">
                                <option value="">--</option>
                                @foreach(range(1, 4) as $score)
                                    <option value="{{ $score }}">{{ $score }}</option>
                                @endforeach
        ...
        form.submit(function(e) {
            ...
            axios.post('{{ route("prod.anak-asuh.update") }}', formData)
