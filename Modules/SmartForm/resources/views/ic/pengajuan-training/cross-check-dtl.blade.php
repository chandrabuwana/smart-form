                        ...
                        <table id="table-data" data-toggle="table" data-side-pagination="server"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="NIK_nama" data-align="left">NIK</th>
                                    <th data-field="KodeST" data-align="left">Site</th>
                                    <th data-field="KodeDP" data-align="left">Department</th>
                                    <th data-field="matrix_kompetensi" data-align="left">Kompetensi</th>
                                    <th data-field="matrix_sertifikasi" data-align="left">Rekap Sertifikasi</th>
                                    <th data-field="status_id" data-align="left">Status</th>
...
@section('custom-js')
    ...
    <script>
        ...
        function actionFormatter(value, row, index) {
            return `<a href="/ic/training/cross-check-dtl/${row.trj_id}"> <button class="btn btn-secondary btn-action-format"><i class="bi bi-info-circle-fill"></i></button> </a>`
        }
    </script>
@endsection