            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Dashboard Laporan Harian Pemakaian Solar (LOG SHEET)</h6>
                    </div>
                </div>
                        ...
                        <table id="list-pengeluaran-oli" data-toggle="table" data-ajax="fetchFormsData"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="total_pemakaian" data-align="left" data-halign="text-center" data-sortable="true">Total Pemakaian</th>
...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        function fetchFormsData(params) {
            ...
            var url = '/bss-form/log/list-pemakaian-solar'
