            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Dashboard Cecklist OGC Compliance</h6>
                    </div>
                </div>
                <div class="card-body my-1">

                    <div class="d-flex align-items-center ms-3">
                        <a href="{{ route('bss-form.log.form-check-ogc') }}">
                    ...
                    <div class="table-responsive p-0">
                        <table id="list-pengeluaran-oli" data-toggle="table" data-ajax="fetchFormsData"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="tanggal" data-align="left" data-halign="text-center" data-sortable="true">Job Site</th>
                                    <th data-field="tanggal" data-align="left" data-halign="text-center" data-sortable="true">No. Lube Station</th>
...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        function fetchFormsData(params) {
            ...
            var url = '/bss-form/log/list-check-ogc'
