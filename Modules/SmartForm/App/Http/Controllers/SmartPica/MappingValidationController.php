...
class MappingValidationController extends Controller {
    ...
    public function IndexMappingValidation(Request $request) {
        return view('SmartForm::smartpica/dashboard-mapping-validation');
    }
    ...
    public function GetListLevelUser(Request $request) {
        ...
        try {
            ...
            $query_level_user = DB::table(self::TABLE_USER_LEVEL)
                ->select('id as nomor', 'Nik as nik', 'Nama as nama', 'lvl as level');
    ...
    public function EditLevelUser(Request $request) {
        ...
        $validator = Validator::make(
            ...
            [
                'nomor' => ['required'],
                'nik' => ['required'],
                'level' => ['required', Rule::in(0, 1, 2, 4, 5)]
            ],
            [
