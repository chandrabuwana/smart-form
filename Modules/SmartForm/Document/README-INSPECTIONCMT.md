# General Inspection CMT Module Documentation

## Document Overview
### Document Purpose
This document provides comprehensive documentation for the General Inspection CMT (Construction Mining Truck) module, which manages equipment inspections across multiple sites.

### Project Name
General Inspection CMT Management - Smart Form Module
...
## Project Overview
### Project Description
The General Inspection CMT module is a specialized component for managing construction mining truck inspections across multiple sites. It handles detailed inspection records with activity checklists, inspection results, and a multi-level approval workflow.
...
### Database Schema
#### Table: plant_general_inspection_cmt
- id (Primary Key)
- creator
- diperiksa (Inspector)
...
#### Table: plant_general_inspection_cmt_activity
- id (Primary Key)
- cmt_id (Foreign Key)
- category
- activity
...
#### Table: plant_general_inspection_cmt_result
- id (Primary Key)
- cmt_id (Foreign Key)
- component
- performance
...
#### 1. Dashboard View
- **Route**: GET `/plant/general-inspection/cmt`
- **Name**: `bss-form.plant.general-inspection.cmt.index`
...
#### 2. Get Data
- **Route**: GET `/plant/general-inspection/cmt/data`
- **Name**: `bss-form.plant.general-inspection.cmt.data`
...
#### 3. Create Form
- **Route**: GET `/plant/general-inspection/cmt/create`
- **Name**: `bss-form.plant.general-inspection.cmt.create`
...
#### 4. Store Record
- **Route**: POST `/plant/general-inspection/cmt`
- **Name**: `bss-form.plant.general-inspection.cmt.store`
...
#### 5. Show Record
- **Route**: GET `/plant/general-inspection/cmt/{id}`
- **Name**: `bss-form.plant.general-inspection.cmt.show`
- **Description**: Show inspection record details
- **Parameters**: Record ID
- **Response**: View with detailed record data

#### 6. Edit Form
- **Route**: GET `/plant/general-inspection/cmt/{id}/edit`
- **Name**: `bss-form.plant.general-inspection.cmt.edit`
- **Description**: Display form for editing inspection
- **Parameters**: Record ID
- **Response**: Form view with existing data

#### 7. Update Record
- **Route**: PUT `/plant/general-inspection/cmt/{id}`
- **Name**: `bss-form.plant.general-inspection.cmt.update`
...
#### 8. Delete Record
- **Route**: DELETE `/plant/general-inspection/cmt/{id}`
- **Name**: `bss-form.plant.general-inspection.cmt.destroy`
- **Description**: Delete inspection record and related data
- **Parameters**: Record ID
- **Response**: Redirect with status

#### 9. Print Record
- **Route**: GET `/plant/general-inspection/cmt/{id}/print`
- **Name**: `bss-form.plant.general-inspection.cmt.print`
...
- **Approve**:
  - **Route**: POST `/plant/general-inspection/cmt/approve`
...
- **Reset**:
  - **Route**: POST `/plant/general-inspection/cmt/reset/{id}`
  - **Description**: Reset approval status
  - **Parameters**: Record ID
  - **Response**: JSON response with status

- **Reject**:
  - **Route**: POST `/plant/general-inspection/cmt/reject`
