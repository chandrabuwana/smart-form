...
@section('custom-js')
    ...
    <script>
        ...
        $('#btnSubmitRole').click( function(e) {
            ...
            axios.post(`{{ isset($roleMaster) ? route('update-role-management', ['id' => $roleMaster->id]) : route('store-role-management') }}`, formData, {
            ...
            .then(function (response) {
                ...
                Swal.fire({
                    ...
                    window.location.href = `{{ route('dashboard-role-management') }}`;
                });
            })
