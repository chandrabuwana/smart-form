...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        function searchKaryawan(nama) {
            axios.get('/produksi/search-karyawan?search='+nama, {
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}
                })
                .then(function(response) {
        ...
        function actionFormatter(value, row, index) {
            return '<a href="/get-forms-timesheet-detail?id=' + row.id + '"><button class="btn btn-primary btn-action text-white">detail</button></a>';
        }
