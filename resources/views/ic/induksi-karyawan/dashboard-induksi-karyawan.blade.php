...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        function RedirectToDetail(obj) {
            ...
            window.location.href = "/bss-form-edit-view-IC-form-induksi/" + d.NIK + "=" + d.created_at;
        }
        ...
        function SubmittAllDataModal() {
            ...
            $.ajax({
                ...
                url: "/add-bss-form-she-019B-petugas-checker",
                data: formData,
                dataType: 'json',
        ...
        function redirectToAddStepPica(obj) {
            ...
            window.location.href = "/add-step-smart-pica/" + $('#dataListFormICInduksiKaryawan').bootstrapTable('getData')[
                    indexDt]
                .nodocpica;
        }
        ...
        function dataListFormICInduksiKaryawanGenerateData(params) {
            var url = '/bss-lst-IC-form-induksi'
