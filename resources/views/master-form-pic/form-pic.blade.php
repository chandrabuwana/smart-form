...
@section('custom-js')
    ...
    <script>
        ...
        $('#btnSubmitFormPIC').click( function(e) {
            ...
            axios.post(`{{ isset($formPIC) ? route('update-master-form-pic', ['id' => $formPIC->id]) : route('store-master-form-pic') }}`, formData, {
            ...
            .then(function (response) {
                ...
                Swal.fire({
                    ...
                    window.location.href = `{{ route('dashboard-master-form-pic') }}`;
                });
            })
